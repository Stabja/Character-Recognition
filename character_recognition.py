...
###Download the dataset from Internet if starting from scratch.###
...
###Extract the tar.gz file downloaded and get the dataset.###
...
###If already unzipped data, Start from HERE***
...
def load_letter(folder, min_num_images):
    ...
    print('Mean:', np.mean(dataset))    print('Standard deviation:', np.std(dataset))
    return dataset
...
###Create a single pickle file for the entire dataset###
